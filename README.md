...
For global memory the memory throughput for the 2D convolution was 200 mb/s compared to the enhancement made with tiling which had a memory thoughput of 800 mb/s.  
